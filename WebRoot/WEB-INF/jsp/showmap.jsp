  ...
  <body>
   <div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Section -->
							<iframe src="map" frameborder="0" width="900" scrolling="No" height="900" leftmargin="0"  topmargin="0"></iframe>
							</div>
					</div>
		...
		<!-- Scripts -->
			...
			<script src="../../assetsss/js/skel.min.js"></script>
