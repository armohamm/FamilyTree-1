...
public class MailUtil {  
    ...
    public static void main(String[] args) {  
        ...
        mail.setSender("13575687607@163.com");  
        mail.setReceiver("13575687607@163.com"); // 接收人  
        mail.setUsername("13575687607@163.com"); // 登录账号,一般都是和邮箱名一样吧  
        mail.setPassword("Baohan531776353"); // 发件人邮箱的登录密码  
